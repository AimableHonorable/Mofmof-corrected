...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { minutes_walk: @station.minutes_walk, property_id: @station.property_id, rail_way_line: @station.rail_way_line, station_name: @station.station_name } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { minutes_walk: @station.minutes_walk, property_id: @station.property_id, rail_way_line: @station.rail_way_line, station_name: @station.station_name } }
